...
(function (e, t) {
  ...
  function r(e) {
    ...
    'TABLE'].indexOf(o.nodeName) && 'static' === t(o, 'position') ? r(o)  : o : e ? e.ownerDocument.documentElement : document.documentElement
  }
  function p(e) {
    var t = e.nodeName;
      ...
      return g.refresh = function () {
        ...
        t.makeArray(t(this._selector)).map(function (e) {
          ...
          if (r && (n = t(r) [0]), n) {
            ...
            if (o.width || o.height) return [t(n) [i]().top + s,
            r]
          }
          return null
        }).filter(function (t) {
...
!function (n, e) {
  ...
  var i = function (n) {
    ...
    return n.fn.mmEmulateTransitionEnd = i,
  ...
  n); return function (n) {
    ...
    o = function () {
      ...
      return s.init = function () {
        ...
        n(this.element).find(t.parentTrigger).has(t.subMenu).children(t.triggerElement).on(r.CLICK_DATA_API, function (i) {
          var s = n(this),
          ...
          'true' !== s.attr('aria-disabled') && (a.hasClass(t.activeClass) ? (s.attr('aria-expanded', !1), e.hide(o))  : (e.show(o), s.attr('aria-expanded', !0), t.toggle && r.attr('aria-expanded', !1)), t.onTransitionStart && t.onTransitionStart(i))
        })
      },
      s.show = function (e) {
        var t = this;
        if (!this.transitioning && !n(e).hasClass(this.config.collapsingClass)) {
          ...
          if (s.trigger(a), !a.isDefaultPrevented()) {
            ...
            this.config.toggle && this.hide(s.parent(this.config.parentTrigger).siblings().children(this.config.subMenu + '.' + this.config.collapseInClass).attr('aria-expanded', !1)),
    ...
    return n.fn[e] = o.jQueryInterface,
